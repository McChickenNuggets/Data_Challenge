...
colnames(all_campus_94_03)<-c('Category','Ethnicity','Academic_year','Count','Percentage')
...
ggplot(data=temp_Admits1, aes(x=Academic_year, y=Percentage, group=Ethnicity)) +
  ...
  labs(title="UC Davis Admits Proportion Change For All Ethnicities Over 2010 to 2019",y='Percentage Share')
